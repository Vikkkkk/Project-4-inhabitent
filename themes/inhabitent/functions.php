...
function red_starter_scripts() {
	...
	//added custom js, the true in the end make it show up before closing of <body> but if leave it bank it will show up in the end of <head>
	wp_enqueue_script( 'inhabitent-custom-js', get_template_directory_uri() . '/js/custom.js', array('jquery',), '', true );
